      ...
      <div class="relative sm:max-w-sm w-full">
        ...
        <div class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
          <div class="flex items-center justify-between">
            ...
            <label class="text-sm text-gray-700 font-semibold"> Registrate </label>
          ...
          <form class="mt-10" @submit.prevent="onRegister">
            <div>
              <input
                v-model="email"
                type="email"
...
const name = ref('josue camargo');
const email = ref('cp@gmail.com');
